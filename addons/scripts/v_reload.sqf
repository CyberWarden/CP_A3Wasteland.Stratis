...
if((player == driver _vehicle) && (!_eng))then {
	...
	_price = 250;
	if(_type == "B_MRAP_01_hmg_F") then {_price = 500;};
	if(_type == "B_MRAP_01_gmg_F") then {_price = 500;};
	if(_type == "O_MRAP_02_hmg_F") then {_price = 500;};
	...
	if(_type == "O_APC_Tracked_02_cannon_F") then {_price = 500;};
	if(_type == "B_APC_Tracked_01_AA_F") then {_price = 500;};
	if(_type == "O_APC_Tracked_02_AA_F") then {_price = 500;};
	if(_type == "B_MBT_01_cannon_F") then {_price = 500;};
	...
	if(_type == "B_Heli_Attack_01_F") then {_price = 1000;};
	if(_type == "O_Heli_Attack_02_F") then {_price = 1000;};
	if(_type == "O_Heli_Attack_02_black_F") then {_price = 1000;};
	if(_type == "I_Plane_Fighter_03_AA_F") then {_price = 1000;};
	if(_type == "I_Plane_Fighter_03_CAS_F") then {_price = 1000;};
	if(_type == "B_Plane_CAS_01_F") then {_price = 1000;};
	if(_type == "O_Plane_CAS_02_F") then {_price = 1000;};
