...
class TOParmaInfoD
{
	...
	{	
		...
		class TAGeneralInfoBackground: RscText
		{
			...
			type = CT_STRUCTURED_TEXT;
			size = 0.030;
			text = "Website: CyberPrison.com Forums: http://cyberprison.com/index.php?forums/";
			x = "0 * (((safezoneW / safezoneH) min 1.2) / 40)";
