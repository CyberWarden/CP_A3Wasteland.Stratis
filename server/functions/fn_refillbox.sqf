...
switch (_boxType) do
{
	case "mission_USLaunchers":
	{
		...
		[
			...
			["mag", "Titan_AA", RANDOM_BETWEEN(5,10)],
			["wep", "launch_Titan_short_F", RANDOM_BETWEEN(1,2), RANDOM_BETWEEN(1,2)],
			["mag", "Titan_AT", RANDOM_BETWEEN(5,10)],
	...
	case "Diver_Gear":
	{
		...
		[
			...
			["itm", "NVGoggles", 1],
			["itm", "B_FieldPack_ghex_F", 1],
			["itm", "U_B_Wetsuit", 1],
			["itm", "U_O_Wetsuit", 1],
			["itm", "U_I_Wetsuit", 1],
			["itm", "V_RebreatherB", 1],
			["itm", "V_RebreatherIR", 1],
			["itm", "V_RebreatherIA", 1],
			["itm",	"G_Diving", 1], 
			["itm",	"H_HelmetO_ViperSP_ghex_F", 1],
			["itm", "FirstAidKit", 1],
			["itm", "Medikit", 1],
			["mag", "MiniGrenade", 1],

			//Add Underwater Rifle and 5 20Rnd Mags
			["wep", "arifle_SDAR_F", 1],
			["mag", "SatchelCharge_Remote_Mag", 2],
			["mag", "20Rnd_556x45_UW_mag", 9],
			
			//Add Pistol and two 16Rnd Mags
			["wep",	"hgun_P07_khk_F", 1],
			["mag",	"16Rnd_9x21_Mag", 2]
		];
	};	
	case "Sniper_Gear":
	{
		...
		[
			//Default Items and Equipment
			["itm", "NVGoggles", 1],
			["itm",	"B_Bergen_tna_F", 1],
			["itm", "B_FieldPack_ghex_F", 1],
			["itm",	"V_TacVestIR_blk", 1],
			["itm",	"H_HelmetO_ViperSP_ghex_F", 1],
			["itm",	"U_O_T_FullGhillie_tna_F", 1],
			["itm",	"U_B_T_FullGhillie_tna_F", 1],
			["itm",	"U_I_FullGhillie_sard", 1],
			["itm",	"muzzle_snds_B_snd_F", 1],
			["itm",	"optic_Nightstalker", 1], 
			["itm", "Medikit", 1],

			//Add Lynx
			["wep",	"srifle_GM6_ghex_LRPS_F", 1],
	...
	case "Engineer_Gear":
	{
		...
		[
			...
			//Add Sting SMG and two 30Rnd Mags
			["wep", "SMG_02_F", 1],
			["mag", "SatchelCharge_Remote_Mag", 2],
			["wep",	"arifle_AK12_F", 1],
			["mag", "30Rnd_9x21_Mag_SMG_02", 2],
			["mag",	"30Rnd_762x39_Mag_F", 4],
